...
const CSV_KEY_TO_APP = {
  ...
  hanuman: [{ ns: 'deities', key: 'hanuman' }],
  narasimha: [{ ns: 'deities', key: 'narasimha' }],
  lakshmi: [{ ns: 'deities', key: 'lakshmi' }],
  durga: [{ ns: 'deities', key: 'durga' }],
  saraswati: [{ ns: 'deities', key: 'saraswati' }],
  ayyappan: [{ ns: 'deities', key: 'ayyappan' }],
  jagannath: [{ ns: 'deities', key: 'jagannath' }],
  dattatreya: [{ ns: 'deities', key: 'dattatreya' }],
  saiBaba: [{ ns: 'deities', key: 'saiBaba' }],
  narayana: [{ ns: 'deities', key: 'narayana' }],
  iskcon: [{ ns: 'deities', key: 'iskcon' }],
  guru: [{ ns: 'deities', key: 'guru' }],
  shani: [{ ns: 'deities', key: 'shani' }],
  rahu: [{ ns: 'deities', key: 'rahu' }],
  ketu: [{ ns: 'deities', key: 'ketu' }],
  maha_japa_yagnas: [{ ns: 'menu', key: 'mahaJapaYagnas' }],
