...
/** POST /api/admin/delete-temple - Delete a temple and its marathons + participations. Body: { templeId } */
export async function POST(request) {
  ...
  try {
    ...
    return jsonInternalServerError(e, 'api/_handlers/admin/delete-temple.js');
  }
}
