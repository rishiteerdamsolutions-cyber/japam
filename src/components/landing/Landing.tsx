        ...
        <div className="relative z-10 flex flex-col min-h-screen">
          ...
          >
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.99 }}
              onClick={onEnterApp}
              className={`w-full max-w-xs py-2.5 sm:py-2.5 px-3 ${LANDING_PRIMARY_FRAME} bg-amber-500 text-white font-bold text-sm sm:text-base hover:shadow-[0_0_40px_rgba(245,158,11,0.5)] hover:bg-amber-400 hover:border-amber-300/70 focus:outline-none focus-visible:ring-2 focus-visible:ring-amber-400/80 break-words text-center leading-tight`}
            >
